	...
	return this.define(function(public) {
		...
		public.getContent = function(callback, encoding) {
			...
			if(typeof callback == 'function') {
				_fs.readFileSync(this.path, encoding, callback);
				return this;
			}
			
			if(this.isPath()) {
				return _fs.readFileSync(this.path, encoding);
			}
		 ...
		 * @return string
		 */
		public.getFolder = function(index) {
			index = index || 0;
		...
		/**
		 * Returns true if the file is a real path in the system
		 *
		 * @return bool
		 */
		public.isPath = function() {
			try {
				return _getStat.call(this).isDirectory() || _getStat.call(this).isFile();
			} catch (e) {}
		...
		public.setContent = function(content, callback) {
			...
			_fs.writeFileSync(this.path, content);
