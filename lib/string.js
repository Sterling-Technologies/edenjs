module.exports = function($) {
	 ...
	 * @return string
	 */
	public.getHtmlTranslationTable = function(table, quote_style) {
		var entities				= {},
			hash_map				= {},
			constMappingTable 		= {},
	...
	public.htmlentities = function(quote_style, charset, double_encode) {
		var hash_map = this.getHtmlTranslationTable('HTML_ENTITIES', quote_style);
		var symbol = '';
	 ...
	 * @return string
	 */
	public.htmlspecialcharsDecode = function(quote_style) {
		var optTemp		= 0,
			i 			= 0
			noquotes	= false;
	 ...
	 * @return string
	 */
	public.htmlEntityDecode = function(quote_style) {
		var histogram 	= {},
			symbol 		= '',
			tmp_str 	= '',
			entity 		= '';
		...
		histogram 	= this.getHtmlTranslationTable('HTML_ENTITIES', quote_style);
	...
	public.sha1 = function() {
		...
		msg = this.utf8Encode(this.string);
	 ...
	 * @return string
	 */
	public.utf8Encode = function(argString) {
